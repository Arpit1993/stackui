...
const DropdownFile = (props) => {
    ...
    return (
        <Menu as="div" className="frelative inline-block z-50 text-left">
          <div className="flex">
          ...
          <Transition as={Fragment} enter="transition ease-out duration-100" enterFrom="transform opacity-0 scale-95" enterTo="transform opacity-100 scale-100" leave="transition ease-in duration-75" leaveFrom="transform opacity-100 scale-100" leaveTo="transform opacity-0 scale-95">
            <Menu.Items className="absolute z-50 border border-black text-xs mt-2 w-[150px] right-0 origin-top-right rounded-md dark:bg-gray-600 bg-white shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none">
              <div className="py-1 z-50 h-[70px] overflow-scroll">
                <Menu.Item>
                  {({ active }) => (
                    <button
