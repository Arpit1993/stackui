          ...
          <div className="relative w-full shadow-md sm:rounded-lg">
            <div className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
              <div className="w-full grid grid-cols-12 text-xs font-medium text-gray-700 uppercase bg-gray-50 dark:bg-gray-700 dark:text-gray-400">
                <div className="col-span-2 w-full px-6 py-3">Title</div>
                <div className="col-span-4 w-full px-6 py-3">Paragraph</div>
                <div className="col-span-3 w-full px-6 py-3">Question</div>
                <div className="col-span-3 w-full px-6 py-3">Answer</div>
              </div>
        ...
        <div className="relative bg-white w-[700px] rounded-lg shadow dark:bg-gray-900">
          ...
          <div className="mb-6 mt-6 w-full flex justify-center">
            <div className="w-[60%]">
              ...
              <input
                ...
                placeholder="Key title (e.g. New Book)"
                value={key}
                required
              />
            </div>
          ...
          <div className="flex justify-center items-center p-6 space-x-2 border-t border-gray-200 rounded-b dark:border-gray-600">
            <button
              ...
              className="text-white flex gap-2 items-center bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800"
            >
              Submit
              {loading ? (
                <svg
