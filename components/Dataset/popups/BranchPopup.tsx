        ...
        <div key={"brnchpp"} className="absolute z-50 top-20 bg-white rounded-lg dark:bg-slate-900 w-full h-[250px] border-[0.5px] border-gray-500">
            ...
            <div className="flex justify-center h-[120px] gap-2">
                <div className="flex flex-col justify-center">
                    <div>
                        <div className="block mb-2 text-sm font-medium text-gray-900 dark:text-gray-300"> Branch name: </div> 
                    ...
                    <div className="flex mt-2">
                        <input key={Math.random()} type="checkbox" checked={copy} onClick={()=>setCopy(!copy)} className="-4 h-4 bg-gray-50 rounded border border-gray-300 focus:ring-3 focus:ring-blue-300 dark:bg-gray-700 dark:border-gray-600 dark:focus:ring-blue-600 dark:ring-offset-gray-800"/>
            ...
            <div className="flex justify-around">
                <div className="px-5 flex justify-end gap-2">
                    <button onClick={() => handleBranchButton()} className="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-blue-600 dark:hover:bg-blue-700 focus:outline-none dark:focus:ring-blue-800">
                        Create branch
                    </button>
                </div>
            </div>
