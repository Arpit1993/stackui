...
const NERFilterPopup = (props) => {
  ...
  const toggleVariable = (toggle, filter, setFilter) => {
    ...
    for (let i = 0; i < Object.keys(cf).length; i++) {
  ...
  const handleApplyFilter = async () => {
    ...
    for (let i = 0; i < Object.keys(entitiesFilter).length; i++) {
    ...
    if (sliderEntities[0] > 0 || sliderEntities[1] < 100) {
      filters[idx] = {
        num_entities: [
          Math.floor((numEntities * sliderEntities[0]) / 100),
          Math.floor((numEntities * sliderEntities[1]) / 100),
        ],
      };
      idx += 1;
    }
    ...
    const getMetadata = async () => {
      await fetch("http://localhost:8000/schema_metadata")
        ...
        .then((res) => {
          ...
          let rFilters: any = {};
          for (let i = 0; i < res.lengths.length; i++) {
  ...
  let entities_buttons: Array<any> = getbuttons(
    entities,
    entitiesFilter,
    setClassFilter,
    nullStr,
  ...
  return (
    <>
      ...
      <div
        key={"flterpp"}
        ref={ref}
        className="transform -translate-x-1/2 left-1/2 bg-white absolute z-40 top-16 rounded-lg dark:bg-gray-900 w-[80%] h-[250px] border-[0.5px] border-gray-500"
      >
        ...
        {query ? (
          ...
          <div className="flex w-full overflow-x-scroll justify-center gap-2 p-1">
            ...
            <div>
              <div className="text-sm">Lengths</div>
              <div className="h-[100px] w-[200px] border rounded-md shadow-inner border-gray-300">
            ...
            <div className="h-[120px] w-[200px]">
              <div className="text-sm">Entity length</div>
              ...
              <div className="mt-[15px] text-sm">Entities per sentence</div>
              <div className="w-[200px] h-8 border rounded-md shadow-inner border-gray-300">
                {/* <div className="flex gap-1 text-xs px-1 w-[198px] text-center rounded-t-md dark:bg-gray-900 bg-gray-200">
                                </div> */}
                <div className="w-full px-5">
