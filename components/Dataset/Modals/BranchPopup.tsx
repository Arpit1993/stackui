      ...
      >
        <div className="relative bg-white w-[500px] rounded-lg shadow dark:bg-gray-900">
          ...
          <div className="p-6 space-y-6 flex flex-col justify-center">
            <div>
              <div>
                <div className="block mb-2 text-sm font-body text-gray-900 dark:text-gray-300">
                  {" "}
                  Branch name:
                </div>
                <input
            ...
            <div className="flex flex-col justify-center">
              <div>
                ...
                <input
                  ...
                  className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500"
                  placeholder="e.g. path/to/my/branch"
                  type="text"
                />
              </div>
            </div>
