...
const Sidebar = () => {
    ...
    return (
        <div className='h-screen w-[17%] py-4 px-3 bg-gray-50 rounded dark:bg-gray-900'>
                <div className='flex flex-col justify-top h-full w-full'>
                    ...
                    <div className="flex flex-col justify-between h-full w-full">
                        <div className="flex justify-start w-full mt-10">
                            <div className='mt-5 flex flex-col list-none font-thin gap-2'>
                                <Link href='/Home' passHref>
                                    <button className="hover:invert py-3 w-full dark:hover:invert-0 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                ...
                                <Link href='/' passHref>
                                    <button disabled={true} className="hover:invert py-3 w-full dark:hover:invert-0 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                        <div className="flex grid-cols-2 gap-6">
                        ...
                        <div className="flex justify-start w-max mb-10">
                            <Link href='/' passHref>
                                <button disabled={true} className="hover:invert py-3 w-full dark:hover:invert-0 flex items-center p-2 text-base font-normal text-gray-900 rounded-lg dark:text-white hover:bg-gray-100 dark:hover:bg-gray-700">
                                    <div className="flex grid-cols-2 gap-6">
