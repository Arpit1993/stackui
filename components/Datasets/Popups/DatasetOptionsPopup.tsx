...
const DatasetOptionsPopup = (props) => {
    ...
    return (
        <>
            {
                <button key={'ccdo'} onClick={() => props.setPopup(false)} className="bg-black/50 absolute top-1/2 left-1/2 transform -translate-x-1/2 -translate-y-1/2 w-screen  h-screen">
                    click to close
                </button>
            }
