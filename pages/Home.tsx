    ...
    return (
        <div className="h-full flex flex-col justify-center">
            <div className='p-10 text-5xl flex flex-col justify-center items-center font-bold h-max text-center'>
                ...
                <span className="block xl:inline bg-gradient-to-r bg-clip-text text-transparent from-blue-800 to-blue-800 via-blue-400 animate-text">Supercharge </span>{' '}
                <span className="block xl:inline">your datasets</span>{' '}
              </h1>
            </div>
            ...
            <div className="p-10 flex justify-center gap-2">
                <Link href="/NewDataset" passHref>
                    <button className="flex focus:outline-none text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-body rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-green-600 dark:hover:bg-green-700 dark:focus:ring-green-800"> 
                        Add a new dataset
                ...
                <div className="flex flex-col justify-center">
                    <Link href="/Datasets" passHref>
                        <button className="flex text-white bg-gray-800 hover:bg-gray-900 focus:outline-none focus:ring-4 focus:ring-gray-300 font-body rounded-lg text-sm px-5 py-2.5 mr-2 mb-2 dark:bg-gray-800 dark:hover:bg-gray-700 dark:focus:ring-gray-700 dark:border-gray-700"> 
